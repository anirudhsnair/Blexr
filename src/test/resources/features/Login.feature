Feature: Login functionality of Evernote
  ...
  Scenario Outline: Registered user login
    ...
    Then Homepage should be displayed
     Examples: 
      | email                     | password   | 
      | anirudh.s.nair@gmail.com | anirudh123$| 
   ...
   Scenario Outline: Warning message for wrong password 
    ...
    Then Warning message <warning message> should be displayed
      ...
      | anirudh.s.nair@gmail.com   | anirudh857$      | Incorrect password. You modified your password in the past 24 hours.|
    
      Scenario: Warning message on leaving email as blank
    Given User is on Login Page
